...
<div class="min-h-[calc(100vh-6rem)] p-8">
  <div class="max-w-7xl mx-auto space-y-8">
    ...
    <div class="text-center mb-4">
      <h1 class="text-4xl font-bold text-primary mb-2">Welcome, {memberInfo.member_name}</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="glass-card p-6">
        ...
        <div class="space-y-3">
          ...
          <button 
            on:click={handleComingSoon}
            class="glass-button w-full text-sm py-3 flex items-center justify-center bg-gradient-to-r from-green-500/20 to-emerald-500/20 hover:from-green-500/30 hover:to-emerald-500/30 transition-all duration-200"
          >
            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button 
            on:click={handleComingSoon}
            class="glass-button w-full text-sm py-3 flex items-center justify-center bg-gradient-to-r from-orange-500/20 to-red-500/20 hover:from-orange-500/30 hover:to-red-500/30 transition-all duration-200"
          >
            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
